...
def sample_mkdocs_config_context() -> dict[str, Any]:
    ...
    return {
        ...
        "navigation": [
            {"Home": "index.md"},
            {"User Guides": ["guides/getting-started.md", "guides/advanced-config.md"]},
            {"API Reference": ["reference/api-reference.md"]},
            {"Help & Support": ["help/troubleshooting.md"]},
...
def mock_mkdocs_provider(
    sample_mkdocs_articles: list[Article], sample_mkdocs_categories: list[Category]
) -> MockProvider:
...
def expected_mkdocs_config_structure() -> dict[str, Any]:
    ...
    return {
        ...
        "theme_fields": {
            "material": ["name", "features", "palette", "font"],
            "readthedocs": ["name", "highlightjs"],
            "mkdocs": ["name"],
        },
        "common_plugins": [
            "search",
        ...
        "material_plugins": ["social", "offline"],
        "markdown_extensions": [
            "toc",
            "admonition",
...
async def mkdocs_test_exporter(
    test_data_dir: Path, mock_mkdocs_provider: MockProvider
) -> MkDocsExporter:
    ...
    with zipfile.ZipFile(archive_path, "w") as zf:
        ...
        zf.writestr(
            "categories.json",
            json.dumps(
                [{"id": "test-cat", "name": "Test Category", "slug": "test-category"}]
            ),
        )
...
class MkDocsTestHelpers:
    ...
    def validate_mkdocs_config(config_yaml: str) -> dict[str, Any]:
        ...
        try:
            ...
            results = {"valid": True, "errors": [], "warnings": [], "config": config}
