...
class TestSEOMetadata:
    ...
    def test_seo_metadata_defaults(self):
        ...
        metadata = SEOMetadata(title="Simple Page", description="A simple page")
...
class TestStructuredData:
    ...
    def test_structured_data_creation(self):
        ...
        author_data = {"@type": "Person", "name": "John Doe"}
    ...
    def test_structured_data_minimal(self):
        ...
        structured_data = StructuredData(type="WebPage", headline="Simple Page")
...
class TestSEOOptimizerInitialization:
    ...
    def test_init_minimal(self):
        ...
        optimizer = SEOOptimizer(
            site_url="https://docs.test.com", site_name="Test Docs"
        )
    ...
    def test_init_complete(self, sample_seo_optimizer):
        ...
        assert (
            sample_seo_optimizer.site_description
            == "Comprehensive documentation for Example project"
        )
        assert sample_seo_optimizer.default_author == "Documentation Team"
        assert (
            sample_seo_optimizer.default_og_image
            == "https://docs.example.com/images/og-default.png"
        )
        assert sample_seo_optimizer.organization_name == "Example Organization"
        assert (
            sample_seo_optimizer.organization_logo
            == "https://docs.example.com/images/logo.png"
        )
    ...
    def test_url_parsing(self):
        ...
        optimizer = SEOOptimizer(
            site_url="https://subdomain.example.com:8080/path/", site_name="Test Site"
        )

        assert (
            optimizer.site_url == "https://subdomain.example.com:8080/path"
...
class TestMetadataGeneration:
    ...
    @pytest.mark.asyncio
    async def test_generate_page_metadata_basic(
        self, sample_seo_optimizer, sample_content
    ):
        ...
        assert (
            metadata.og_image == "https://docs.example.com/images/og-default.png"
        )  # From default

    @pytest.mark.asyncio
    async def test_generate_page_metadata_with_overrides(
        self, sample_seo_optimizer, sample_content
    ):
        ...
        assert metadata.modified_date == modified_date
        assert (
            metadata.og_image == "https://docs.example.com/images/custom.png"
        )  # Override default
    ...
    async def test_generate_page_metadata_empty_content(self, sample_seo_optimizer):
        ...
        metadata = await sample_seo_optimizer.generate_page_metadata(
            title="Empty Page", content="", url_path="/empty/"
        )

        assert metadata.title == "Empty Page"
        assert (
            metadata.description
            == "Learn about Empty Page in our comprehensive documentation."
        )
        assert metadata.canonical_url == "https://docs.example.com/empty/"

    def test_generate_description_from_content(
        self, sample_seo_optimizer, sample_content
    ):
        """Test description generation from content."""
        description = sample_seo_optimizer._generate_description(
            sample_content, "Test Title"
        )
...
class TestStructuredDataGeneration:
    ...
    @pytest.mark.asyncio
    async def test_generate_structured_data_complete(
        self, sample_seo_optimizer, sample_content
    ):
        ...
        structured_data = await sample_seo_optimizer.generate_structured_data(
            metadata=metadata, content=sample_content
        )
    ...
    async def test_generate_structured_data_minimal(self, sample_seo_optimizer):
        ...
        structured_data = await sample_seo_optimizer.generate_structured_data(
            metadata=metadata, content="Simple content"
        )
    ...
    async def test_generate_structured_data_with_dates(self, sample_seo_optimizer):
        ...
        structured_data = await sample_seo_optimizer.generate_structured_data(
            metadata=metadata, content="Content with dates"
        )
    ...
    async def test_structured_data_json_ld_output(self, sample_seo_optimizer):
        ...
        structured_data = await sample_seo_optimizer.generate_structured_data(
            metadata=metadata, content="Test content for structured data"
        )
...
class TestConfigurationGeneration:
    ...
    def test_generate_analytics_config_no_feedback(self, sample_seo_optimizer):
        ...
        config = sample_seo_optimizer.generate_analytics_config(
            google_analytics="G-XXXXXXXXXX", enable_feedback=False
        )
...
class TestSEOValidation:
    ...
    def test_validate_seo_config_valid(self, sample_seo_optimizer):
        ...
        config = {
            ...
            "extra": {"social": [], "analytics": {"provider": "google"}},
        }
...
class TestSitemapGeneration:
    ...
    async def test_generate_sitemap_urls_basic(self, sample_seo_optimizer):
        ...
        pages = [
            {"url": "/", "title": "Home", "modified_date": "2025-01-08T12:00:00Z"},
            {
                ...
                "modified_date": "2025-01-10T15:30:00Z",
            },
            {
                "url": "/api/",
                "title": "API Reference",
                "modified_date": "2025-01-05T10:00:00Z",
            },
        ]
    ...
    async def test_generate_sitemap_urls_with_custom_maps(self, sample_seo_optimizer):
        ...
        pages = [
            {
                "url": "/custom/",
                "title": "Custom Page",
                "modified_date": "2025-01-08T12:00:00Z",
            },
            {
                "url": "/other/",
                "title": "Other Page",
        ...
        sitemap_urls = await sample_seo_optimizer.generate_sitemap_urls(
            pages=pages, priority_map=priority_map, changefreq_map=changefreq_map
        )
    ...
    async def test_generate_sitemap_urls_date_handling(self, sample_seo_optimizer):
        ...
        for url in sitemap_urls:
            ...
            assert (
                url["lastmod"].endswith("Z") or "+" in url["lastmod"]
            )  # Valid ISO format
...
class TestIntegrationScenarios:
    ...
    async def test_complete_seo_workflow(self, sample_seo_optimizer, sample_content):
        ...
        analytics_config = sample_seo_optimizer.generate_analytics_config(
            google_analytics="G-TEST123", enable_feedback=True
        )
    ...
    async def test_multilingual_support(self):
        ...
        optimizer = SEOOptimizer(
            site_url="https://docs.example.com/es", site_name="Documentación de Ejemplo"
        )
    ...
    def test_edge_case_empty_inputs(self, sample_seo_optimizer):
        ...
        assert (
            description
            == "Learn about Empty Content in our comprehensive documentation."
        )
    ...
    def test_url_handling_edge_cases(self):
        ...
        optimizer1 = SEOOptimizer(
            site_url="https://docs.example.com/", site_name="Test"
        )
        assert optimizer1.site_url == "https://docs.example.com"

        # Test with path
        optimizer2 = SEOOptimizer(
            site_url="https://example.com/docs/", site_name="Test"
        )
        assert optimizer2.site_url == "https://example.com/docs"

        # Test with port
        optimizer3 = SEOOptimizer(site_url="https://localhost:8000/", site_name="Test")
